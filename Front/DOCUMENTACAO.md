...
Sistema de gerenciamento de usuários com integração NFC para controle de acesso. Desenvolvido em Flutter com comunicação com backend Flask.
...
│       ├── user_modal.dart       # Modal para usuários
│       └── user_nfc_modal.dart   # Modal para vincular NFC
│
